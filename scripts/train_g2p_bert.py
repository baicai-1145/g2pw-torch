...
import os
# Set Hugging Face endpoint to a mirror for users in regions with limited access.
...
def main(config_path):
    ...
    tokenizer_source = config.tokenizer_source if hasattr(config, 'tokenizer_source') else config.model_source
